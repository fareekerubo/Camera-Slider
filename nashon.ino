...
#define JoyX A1       // Joystick X pin
#define JoyY A0       // Joystick Y pin
#define slider A4     // Slider potentiometer
#define inOutPot A3   // In and Out speed potentiometer
#define JoySwitch 13  // Joystick switch connected
#define InOutSet 2   // Set Button
#define limitSwitch 6
#define inLED 4
#define outLED 3
// Define the stepper motors and the pins the will use
AccelStepper stepper1(1, 8, 7); // (Type:driver, STEP, DIR)
